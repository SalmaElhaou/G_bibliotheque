...
public class GestionUsager extends javax.swing.JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        panRecherch.setBackground(new java.awt.Color(128,128,128));
        panRecherch.setForeground(new java.awt.Color(0, 250, 255));
        panRecherch.setBorder(javax.swing.BorderFactory.createTitledBorder("Rechercher"));
        
        RecherchParLabel.setFont(new java.awt.Font("PLAIN", 1, 14));
        RecherchParLabel.setForeground(new java.awt.Color(0, 250, 255));
        ...
        panListeUsager.setBackground(new java.awt.Color(128,128,128));
        ...
        panAjoutUsager.setBackground(new java.awt.Color(128,128,128));
        panAjoutUsager.setBorder(javax.swing.BorderFactory.createTitledBorder("Ajout Usager"));

        panAjoutBas.setBackground(new java.awt.Color(128,128,128));
        panAjoutBas.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        civiliteLabel.setFont(new java.awt.Font("PLAIN", 1, 14)); // NOI18N
        civiliteLabel.setForeground(new java.awt.Color(0, 250, 255));
        civiliteLabel.setText("Civilité : ");

        matriculeLabel.setFont(new java.awt.Font("PLAIN", 1, 14)); // NOI18N
        matriculeLabel.setForeground(new java.awt.Color(0, 250, 255));
        ...
        prenomLabel.setFont(new java.awt.Font("PLAIN", 1, 14)); // NOI18N
        prenomLabel.setForeground(new java.awt.Color(0, 250, 255));
        ...
        nomLabel.setFont(new java.awt.Font("PLAIN", 1, 14)); // NOI18N
        nomLabel.setForeground(new java.awt.Color(0, 250, 255));
        nomLabel.setText("Nom  ");

        telLabel.setFont(new java.awt.Font("PLAIN", 1, 14)); // NOI18N
        telLabel.setForeground(new java.awt.Color(0, 250, 255));
        telLabel.setText("Téléphone  ");

        dateLabel.setFont(new java.awt.Font("PLAIN", 1, 14)); // NOI18N
        dateLabel.setForeground(new java.awt.Color(0, 250, 255));
        dateLabel.setText("Date de naissance  ");

        nomField.setPreferredSize(new java.awt.Dimension(123, 26));

        civiliteCombo.setFont(new java.awt.Font("PLAIN", 1, 12)); // NOI18N
        ...
        prenomLabel1.setFont(new java.awt.Font("PLAIN", 1, 14)); // NOI18N
        prenomLabel1.setForeground(new java.awt.Color(0, 250, 255));
        ...
        annulerBouton.setFont(new java.awt.Font("Times New Roman", 1, 16));
        // NOI18N
